...
public class ClickGui extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        //if (!listeningForKey) {
        //    mc.fontRenderer.drawString("Bind: " + getKeyDisplayString(selectedModule.getKey()), (int) (posX2 + 5), (int) (posY2 + 5), -1);
        //} else {
        //    mc.fontRenderer.drawString("Listening... ", (int) (posX2 + 5), (int) (posY2 + 5), -1);
        //}
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        //if (isInside2(mouseX, mouseY, posX2, posY2, posX2 + 150, posY2 + 17.5)) {
        //    if (!listeningForKey) {
