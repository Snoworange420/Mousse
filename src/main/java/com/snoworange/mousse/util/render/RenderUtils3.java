...
public class RenderUtils3
{
    ...
    public static void drawCircle(final BlockPos blockPos, final double n, final double n2, final Color color, final Color color2) {
        glSetup3d();
        AxisAlignedBB box = new AxisAlignedBB(blockPos.getX() - mc.getRenderManager().viewerPosX, blockPos.getY() - mc.getRenderManager().viewerPosY, blockPos.getZ() - mc.getRenderManager().viewerPosZ, blockPos.getX() + 1 - mc.getRenderManager().viewerPosX, blockPos.getY() + 1 - mc.getRenderManager().viewerPosY, blockPos.getZ() + 1 - mc.getRenderManager().viewerPosZ);
    ...
    static {
        RenderUtils3.tessellator = Tessellator.getInstance();
        RenderUtils3.bufferbuilder = RenderUtils3.tessellator.getBuffer();
    }
}
