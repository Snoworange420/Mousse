...
import com.snoworange.mousse.util.render.AnimationUtils.Mode;
...
public class Color extends EaseValue {
    ...
    public void updateEase() {
        ...
        this.red = lastRed + AnimationUtils.easing(easeMode, time / duration, easeToRed - lastRed);
        this.green = lastGreen + AnimationUtils.easing(easeMode, time / duration, easeToGreen - lastGreen);
        this.blue = lastBlue + AnimationUtils.easing(easeMode, time / duration, easeToBlue - lastBlue);
        this.alpha = lastAlpha + AnimationUtils.easing(easeMode, time / duration, easeToAlpha - lastAlpha);
    }
