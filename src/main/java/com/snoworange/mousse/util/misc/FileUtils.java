...
public class FileUtils {
    ...
    public static void saveModuleSetting(final File file) {
        Exception ex;
        try {

            for (Module m : Main.moduleManager.getModuleList()) {
                File module = new File(config, m.getName() + ".txt");
                if (!module.exists()) {
    ...
    public static void loadModuleSetting(final File file) {
        try {
            if (config.isDirectory()) {
                for (Module m : Main.moduleManager.getModuleList()) {
                    File SettingFile = new File(config, m.getName() + ".txt");
                    try {
